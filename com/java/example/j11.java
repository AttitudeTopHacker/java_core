...
public class j11 {
    ...
    static void numberToWords(char[] num) {
        ...
        String[] twodigits = new String[]{"", "Ten", "Eleven", "Twelve", "Thirteen", "Fourteen", "Fifteen", "Sixteen", "Seventeen",
                "Eighteen", "Nineteen"};
        ...
        while (x < num.length) {
            if (len >= 3) {
                ...
                if (num[x] - '0' == 1) {
                    ...
                    int i = (num[x] - '0');
                    if (i > 0) System.out.print(multipleoftens[i] + " ");
